...
<head>
    ...
    <title>Add New profile - SantriKoding.com</title>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('birth') is-invalid @enderror" name="birth" value="{{ old('birth') }}" placeholder="Masukkan birth">
