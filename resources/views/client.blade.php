              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/PHC-Suite-Room-Bedroom.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Apartement</h6>
              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/Rental-homes-in-Bali-Home-in-Ubud.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Villa</h6>
              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/Tampak-Depan-Rumah-Minimalis-Sederhana.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Home</h6>
              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/meeting1.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Office</h6>
              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/Morpheus-Hotel-Macau-City-of-Dreams-Lobby-Zaha-Hadid-5abdb4293128340037fb6f66.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Building</h6>
              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/property-2.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Townhouse</h6>
              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/shop.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Shop</h6>
              ...
              >
                <div class="rounded p-4">
                  <div class="icon mb-3">
                    <img
                      class="img-fluid"
                      src="{{asset('Reservasi/img2/Photo/wp1846068.jpg')}}"
                      alt="Icon"
                    />
                  </div>
                  <h6>Garage</h6>
          ...
          <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
              <div class="about-img position-relative overflow-hidden p-5 pe-0">
                <img class="img-fluid w-100" src="{{asset('Reservasi/img/about.jpg')}}" />
              </div>
            </div>
              ...
              <div class="row g-4">
                  ...
                  <div class="property-item rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                      <a href="reservation1.php"
                        ><img class="img-fluid" src="{{asset('Reservasi/img/property-1.jpg')}}" alt=""
                      /></a>
                      <div
                    ...
                    <div class="p-4 pb-0">
                      <h5 class="text-primary mb-3">Rp.185.000.000</h5>
                      <a class="d-block h5 mb-2" href="reservation1.php"
                        >Golden Urban House For Sell</a
                      >
                      <p>
                        <i class="fa fa-map-marker-alt text-primary me-2"></i
                        >Ahmad Yani Street, Jakarta, Indonesia
                      </p>
                    </div>
                ...
                >
                  <div class="property-item rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                      <a href="reservation1.php"
                        ><img class="img-fluid" src="{{asset('Reservasi/img/property-2.jpg') }}" alt=""
                      /></a>
                      <div
                        class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3"
                      >
                ...
                >
                  <div class="property-item rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                      <a href="reservation1.php"
                        ><img class="img-fluid" src="{{asset('Reservasi/img/property-3.jpg')}}" alt=""
                      /></a>
                      <div
                        class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3"
                      >
                ...
                >
                  <div class="property-item rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                      <a href="reservation1.php"
                        ><img class="img-fluid" src="{{asset('Reservasi/img/property-4.jpg')}}" alt=""
                      /></a>
                      <div
                        class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3"
                      >
                ...
                >
                  <div class="property-item rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                      <a href="reservation1.php"
                        ><img class="img-fluid" src="{{asset('Reservasi/img/property-5.jpg')}}" alt=""
                      /></a>
                      <div
                        class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3"
                      >
                ...
                >
                  <div class="property-item rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                      <a href="reservation1.php"
                        ><img class="img-fluid" src="{{asset('Reservasi/img/property-6.jpg')}}" alt=""
                      /></a>
                      <div
                        class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3"
                      >
              ...
              <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="property-item rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                      <a href="reservation1.php"
                        ><img class="img-fluid" src="{{asset('Reservasi/property-4.jpg')}}" alt=""
                      /></a>
                      <div
                        class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3"
                      >
              ...
              <div class="row g-2 pt-2">
                <div class="col-4">
                  <img
                    ...
                    src="{{asset('Reservasi/img/property-1.jpg')}}"
                    alt=""
                  />
                </div>
                <div class="col-4">
                  <img
                    class="img-fluid rounded bg-light p-1"
                    src="{{asset('Reservasi/img/property-2.jpg')}}"
                    alt=""
                  />
                </div>
                <div class="col-4">
                  <img
                    class="img-fluid rounded bg-light p-1"
                    src="{{asset('Reservasi/img/property-3.jpg')}}"
                    alt=""
                  />
                </div>
                <div class="col-4">
                  <img
                    class="img-fluid rounded bg-light p-1"
                    src="{{asset('Reservasi/img/property-4.jpg')}}"
                    alt=""
                  />
                </div>
                <div class="col-4">
                  <img
                    class="img-fluid rounded bg-light p-1"
                    src="{{asset('Reservasi/img/property-5.jpg')}}"
                    alt=""
                  />
                </div>
                <div class="col-4">
                  <img
                    class="img-fluid rounded bg-light p-1"
                    src="{{asset('Reservasi/img/property-6.jpg')}}"
                    alt=""
                  />
                </div>
              </div>
